...
from net.chancomb2d import *
from solver.solver2d import Solver2D
from solver.combinesolver2d import *
...
solver_params['model_name'] = 'chancomb'
model_path = []
path1 = 'models/arcchan.cpkt-30000'
path2 = 'models/descchan.cpkt-30000'
...
plot_params['save_name'] = 'output/chancomb.png'
...
net = ChanComb2D(common_params, net_params)
